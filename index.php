	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">LearniFy</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://www.instagram.com/rajesh_jain02" class="fa fa-instagram"></a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/urvashi.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Urvashi Bandal</h4>
							...
							<div class="team-member text-center">
								<img src="img/IMG_20230521_144128.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Rajesh Jain</h4>
							...
							<div class="team-member text-center">
								<img src="img/mahii.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Mahima Rao</h4>
									<h4 class="team-member-designation">FrontEnd Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												LearniFy is an online E-learning website <br>
